package mhw.ledou.com.mcd.status;
...
public static void setstatus(Activity mactivity){
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
        ...
        //设置系统栏设置颜色
        tintManager.setTintColor(R.color.basebg);
        //给状态栏设置颜色
        tintManager.setStatusBarTintResource(R.color.basebg);
        //Apply the specified drawable or color resource to the system navigation bar.
        //给导航栏设置资源
        tintManager.setNavigationBarTintResource(R.color.basebg);
    }
}
