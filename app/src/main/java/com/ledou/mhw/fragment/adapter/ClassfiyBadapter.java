...
import com.ledou.mhw.getimg.Getimg;
...
public class ClassfiyBadapter extends RecyclerView.Adapter<ClassfiyBadapter.ViewHolder>{
    ...
    public ClassfiyBadapter(Context context,List<Bclass> list) {
    ...
    public void onBindViewHolder(ClassfiyBadapter.ViewHolder holder, int position) {
        holder.classright.setText(list.get(position).getClass_name()+"");
        ImgUtils.getimgutils().GetImg(context,list.get(position).getClass_pic(),holder.right_img);
